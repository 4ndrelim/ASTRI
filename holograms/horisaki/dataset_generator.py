...
if __name__ == "__main__":
    ...
    #     transformed = normalize(apply_fresnel_propagation_np(hologram))
    ...
    #     print(np.min(hologram))
    #     print(np.max(hologram))
    #     print("Pixel values original: ", np.sum(target))
    #     print("Pixel values hologram: ", np.sum(hologram))
    #     print("Vals after norm: ", np.sum(apply_gerchberg_saxton(normalize(target))))
